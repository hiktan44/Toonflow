...
export default router.post(
 ...
 // Deletenot in assetsItem child items
 ...
 // first set o_assets.imageId set to null, release foreign key constraint, thenDelete o_imageDelete o_assets
 ...
 res.status(200).send(success({ message: "Asset added successfully" }));
 },
);
