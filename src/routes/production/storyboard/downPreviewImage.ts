...
export default router.post(
 ...
 // by storyboardIds build filePath mapping
 ...
 // readallimage buffer getdata
 // sharp underlying libvips at composite will decode all input to memory pixels then composite,noconvert to
 ...
 // generate numbered composite layers for each image
 ...
 // use sharp create canvas and composite, output PNG no
