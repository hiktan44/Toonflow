/**
 * Toonflow AIVendortemplate - DeepSeek
 * @version 2.0
 */
...
const vendor: VendorConfig = {
 ...
 name: "DeepSeek",
 description:
 "DeepSeek relatedicialinterfacesupports V4 series\n\n[go toPlatform](https://platform.deepseek.com/)",
 icon: "",
 inputs: [
 { key: "apiKey", label: "API Key", type: "password", required: true },
 { key: "baseUrl", label: "request URL", type: "url", required: true, placeholder: "examplehttps://api.deepseek.com" },
 ],
 inputValues: {
 apiKey: "",
...
const textRequest = (model: TextModel, think: boolean, thinkLevel: 0 | 1 | 2 | 3) => {
 ...
 // DeepSeek supports high / maxlowmedium mapping highxhigh mapping max
