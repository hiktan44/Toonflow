...
const vendor: VendorConfig = {
 ...
 version: "2.0",
 author: "Toonflow",
 name: "OpenAIstandard API",
 description: "OpenAIinterfaceeditrequest URLAdd",
 icon: "",
 inputs: [
 { key: "apiKey", label: "API Key", type: "password", required: true },
 { key: "baseUrl", label: "request URL", type: "url", required: true, placeholder: "v1examplehttps://api.openai.com/v1" },
 ],
 inputValues: {
 apiKey: "",
